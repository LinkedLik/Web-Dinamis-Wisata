...
<?php 
    ...
    if(isset($_POST['Simpan'])){   
        ...
        if(($ekstensifile == "jpg") or ($ekstensifile == "JPG"))
        {
            ...
            mysqli_query($connection, "INSERT into hotel value ('$hotelID','$hotelnama',
                                        '$hotelalamat','$hotelketerangan','$nama','$areaID')");
    ...
    <form method="POST" enctype="multipart/form-data">
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                ...
                placeholder="Kode Hotel" maxlength="4" required>
            </div>
        </div>
