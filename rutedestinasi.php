...
<?php 
    ...
    if(isset($_POST['Simpan'])){   
        ...
        $areaID = $_POST['inputkodearea'];
            ...
            mysqli_query($connection, "INSERT into rutedestinasi value ('$ruteID','$asal',
                                        '$tanggalberangkat','$tujuan','$tanggaltiba','$areaID')");
    ...
    <form method="POST" enctype="multipart/form-data">
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                ...
                placeholder="Kode Rute" maxlength="4" required>
            </div>
        </div>
