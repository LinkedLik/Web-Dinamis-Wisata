...
<?php 
    ...
    $editkabupaten = mysqli_query($connection, "SELECT * FROM restoran, kabupaten
    WHERE restoranID = '$restoranID' and restoran.kabupatenKODE = kabupaten.kabupatenKODE ");
...
?>
    ...
    <form method="POST" enctype="multipart/form-data">
        <div class="form-group row">
            <label for="kodehotel" class="col-sm-2 col-form-label">Kode Restoran</label>
            <div class="col-sm-10">
                <input type="text" class="form-control" id="kode" name="inputkode"
                value="<?php echo $rowedit['restoranID']?>" maxlength="4" readonly>
            </div>
        </div>

        <div class="form-group row">
            <label for="nama" class="col-sm-2 col-form-label">Nama Restoran</label>
            <div class="col-sm-10">
        ...
        <div class="form-group row">
            <label for="keterangan" class="col-sm-2 col-form-label">Restoran Keterangan</label>
            <div class="col-sm-10">
                <input type="text" class="form-control" id="keterangan" name="inputket"
                value="<?php echo $rowedit['restoranKETERANGAN']?>">
            </div>
        </div>
            ...
            <tbody>
                ...
                { ?>
                        <tr>
                            ...
                            <td>
                                <a href="restoranubah.php?ubah=<?php echo $row['restoranID']?>" class="btn btn-success btn-sm" title="EDIT">
                            ...
                            <td>
                                <a href="restoranhapus.php?hapus=<?php echo $row['restoranID']?>" class="btn btn-danger btn-sm" title="DELETE">
