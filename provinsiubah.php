...
<?php 
    ...
    if(isset($_POST['Edit'])){
        ...
        $provinsitanggal = $_POST['inputtanggal'];

        mysqli_query($connection, "UPDATE provinsi set provinsiNAMA='$provinsinama', 
                                    provinsiTANGGALBERDIRI='$provinsitanggal'
    ...
    <form method="POST" enctype="multipart/form-data">
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                ...
                value="<?php echo $rowedit['provinsiID']?>" maxlength="4" required readonly>
            </div>
        </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                ...
                value="<?php echo $rowedit['provinsiNAMA']?>">
            </div>
        </div>

        <div class="form-group row">
            <label for="keterangan" class="col-sm-2 col-form-label">Provinsi Tanggal Berdiri</label>
            <div class="col-sm-10">
                <input type="date" class="form-control" id="tanggal" name="inputtanggal"
                value="<?php echo $rowedit['provinsiTANGGALBERDIRI']?>">
            </div>
        </div>
            ...
            <tbody>
                ...
                { ?>
                        <tr>
                            ...
                            <td>
                                <a href="provinsiubah.php?ubah=<?php echo $row['provinsiID']?>" class="btn btn-success btn-sm" title="EDIT">
