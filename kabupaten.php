...
<?php 
    ...
    if(isset($_POST['Simpan'])){   
        ...
        if(($ekstensifile == "jpg") or ($ekstensifile == "JPG"))
        {
            ...
            mysqli_query($connection, "INSERT into kabupaten value ('$kabupatenKODE','$kabupatenNAMA',
                                        '$kabupatenALAMAT','$kabupatenKET','$nama','$kabupatenFOTOICONKET')");
    ...
    <form method="POST" enctype="multipart/form-data">
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                ...
                placeholder="Kode Kabupaten" maxlength="4" required>
            </div>
        </div>
        ...
        <div class="form-group row">
            <label for="iconkabupaten" class="col-sm-2 col-form-label">Keterangan Icon Kabupaten</label>
            <div class="col-sm-10">
                <input type="text" class="form-control" id="keteranganicon" name="inputketicon"
                placeholder="Keterangan icon Kabupaten">
            </div>
        </div>
