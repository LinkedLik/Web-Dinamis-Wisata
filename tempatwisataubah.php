<!-- SELESAI SEHIN 05 DESEMBER 2022 PUKUL 17:10-->
<!DOCTYPE html>
<html lang="en">
<!-- KONEKSI KE DATABASE -->
<?php 
...
<?php 
    ...
    if(isset($_POST['Edit'])){   
        ...
        if(empty($nama)){
            mysqli_query($connection, "UPDATE tempatwisata SET wisataNAMA='$wisataNAMA', 
                                        wisataFOTOKETERANGAN='$wisataFOTOKETERANGAN', kabupatenKODE='$kabupatenKODE'
        ...
        if(($ekstensifile == "jpg") or ($ekstensifile == "JPG"))
        {
            ...
            mysqli_query($connection, "UPDATE tempatwisata SET wisataNAMA='$wisataNAMA', wisataFOTO='$nama',
                            wisataFOTOKETERANGAN='$wisataFOTOKETERANGAN',kabupatenKODE='$kabupatenKODE'
                            WHERE wisataID='$wisataID'");
            header("location:tempatwisata.php");
        }
    ...
    $wisataID = $_GET["ubafoto"];
    $editwisata = mysqli_query($connection, "SELECT * FROM tempatwisata
                            WHERE wisataID = '$wisataID'");
    $rowedit = mysqli_fetch_array($editwisata);

    $editkabupaten = mysqli_query($connection, "SELECT * FROM tempatwisata, kabupaten
    WHERE wisataID = '$wisataID' and tempatwisata.kabupatenKODE = kabupaten.kabupatenKODE");
    ...
    <form method="POST" enctype="multipart/form-data">
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                ...
                value="<?php echo $rowedit['wisataID']?>" maxlength="4" required readonly>
            </div>
        </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                ...
                value="<?php echo $rowedit['wisataNAMA']?>">
            </div>
        </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                ...
                <img src="images/<?php echo $rowedit['wisataFOTO']?>" style="width: 200px; height:100px;">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                ...
                value="<?php echo $rowedit['wisataFOTOKETERANGAN']?>">
            </div>
        </div>
