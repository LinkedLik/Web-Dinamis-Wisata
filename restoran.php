...
<?php 
    ...
    if(isset($_POST['Simpan'])){   
        ...
        $kabupatenID = $_POST['inputkodekabupaten'];
            
            mysqli_query($connection, "INSERT into restoran value ('$restoranID','$restorannama',
                                        '$restoranketerangan','$kabupatenID')");
...
?>
    ...
    <div class="col-sm-10">
        <div class="jumbotron jumbotron-fluid">
            <div class="container">
                <h1 class="display-4">Input Data Restoran</h1>
            </div>
        </div>
    ...
    <form method="POST" enctype="multipart/form-data">
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                ...
                placeholder="Kode Restoran" maxlength="4" required>
            </div>
        </div>
