...
<?php
    ...
    if(isset($_POST['Simpan'])){
        ...
        mysqli_query($connection, "INSERT into area values ('$areaID', '$areanama', 
                                  '$areawilayah', '$areaketerangan', '$kabupatenKODE')");
...
<div class="col-sm-10">
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" id="kodearea" name="inputkode" placeholder="Kode area" maxlength="4" required>
    </div>
  </div>
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" name="inputwilayah" id="wilayah" placeholder="Area Wilayah">
    </div>
  </div>
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" name="inputket" id="keterangan" placeholder="Area Keterangan">
    </div>
  </div>
