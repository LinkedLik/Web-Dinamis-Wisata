...
<div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
  <div class="carousel-inner">
    ...
    <div class="carousel-item">
        <img src="images/614eba86bfd35.jpg" class="d-block w-100" alt="Telaga Warna">
    </div>
    <div class="carousel-item">
...
<div class="container">
    <div class="col-sm-12">
        <div class="jumbotron jumbotron-fluid">
            <h1 class="display-1">Berita Wisata Terkini</h1>
        </div>
    </div>
</div>
...
<div class="container">
    <div class="row">        
            <?php if(mysqli_num_rows($berita)>0){
                ...
                <div class="media">
                    <div class="media-boy">
                        <h2 class="mt-0 mb-1"><?php echo $row2["beritajudul"]?></h2>
                        <h6>Penulis : <?php echo $row2["penulis"]?></h6>
                        <h6>Penerbit : <?php echo $row2["penerbit"]?></h6>
                        <h6>Tanggal : <?php echo $row2["tanggalterbit"]?></h6>
...
<div class="container">
    <div class="col-sm-12">
        <div class="jumbotron jumbotron-fluid">
            <h2 class="display-1">Icon Terkenal Kabupaten Kabupaten di Jawa</h2>
        </div>
    </div>
</div>
...
<div class="row row-cols-1 row-cols-md-2">
    <div class="col mb-4">
        ...
        while ($row3 = mysqli_fetch_array($kabupaten)){?>
        <div class="card">
        <img src="images/<?php echo $row3["kabupatenFOTOICON"]?>" class="card-img-top" alt="..."
            style="width: auto; height: auto">
            <div class="card-body">
            <h5 class="card-title"><?php echo $row3["kabupatenNAMA"]?></h5>
            <p class="card-text"><?php echo $row3["kabupatenKET"]?></p>
            <p class="card-text"><small class="text-muted">Icon : <?php echo $row3["kabupatenFOTOICONKET"]?></small></p>
            <p class="card-text"><small class="text-muted">Lokasi : <?php echo $row3["kabupatenALAMAT"]?></small></p>
            </div>
        </div>
        <br><br>
        <?php } } ?>
...
<div class="container">
    <div class="col-sm-12">
        <div class="jumbotron jumbotron-fluid">
            <h2 class="display-1">Provinsi</h2>
        </div>
    </div>
</div>
...
<div class="container">
    <div class="row">        
            <?php if(mysqli_num_rows($provinsi)>0){
                while ($row4 = mysqli_fetch_array($provinsi)){?>
                <div class="media">
                    <div class="media-boy">
                        <h2 class="mt-0 mb-1"><?php echo $row4["provinsiNAMA"]?></h2>
                        <h6>Penulis : <?php echo $row4["provinsiTANGGALBERDIRI"]?></h6>
                    <?php   }   }  ?>
                    </div>
                </div>
            </div>
