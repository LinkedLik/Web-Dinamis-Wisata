...
<?php
    ...
    if(isset($_POST['Simpan'])){
        ...
        $destinasiID = $_POST["inputkodedestinasi"];

        mysqli_query($connection, "INSERT into berita values ('$beritaID', '$beritajudul', '$beritainti',
                                    '$penulis', '$penerbit', '$tanggalterbit', '$destinasiID')");
...
<div class="col-sm-10">
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" id="kodeberita" name="inputkode" placeholder="Kode berita" maxlength="4" required>
    </div>
  </div>
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" name="inputjudul" id="judul" placeholder="Judul Berita">
    </div>
  </div>
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" name="inputinti" id="inti" placeholder="inti Berita">
    </div>
  </div>
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" name="inputpenulis" id="penulis" placeholder="Penulis">
    </div>
  </div>
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" name="inputpenerbit" id="penerbit" placeholder="Penerbit">
    </div>
  </div>
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-10">
      <input type="date" class="form-control" name="inputtanggal" id="tanggal" placeholder="Tanggal Terbit">
    </div>
  </div>
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-10">
    <select class="form-control" id="kodedestinasi" name="inputkodedestinasi">
    ...
    <table class="table table-hover table-danger">
        ...
        { ?>
                <tr>
                    ...
                    <td>    
                        <a href="beritaubah.php?ubah=<?php echo $row["beritaID"]?>" class="btn btn-success btn-sm" title="EDIT">
