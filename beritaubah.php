...
<?php
    ...
    if(isset($_POST['Edit'])){
        ...
        mysqli_query($connection, "UPDATE berita set beritajudul='$beritajudul', 
                      beritainti='$beritainti', penulis='$penulis', penerbit='$penerbit',
                      tanggalterbit='$tanggalterbit', destinasiID='$destinasiID'
                      WHERE beritaID='$beritaID'");
        header("location:berita.php");
    }
...
$editkabupaten = mysqli_query($connection, "SELECT * FROM berita, destinasi
...
<div class="col-sm-10">
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-10">
      ...
      value="<?php echo $rowedit['beritaID']?>" maxlength="4" readonly>
    </div>
  </div>
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" name="inputjudul" id="judul" 
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" name="inputinti" id="inti" 
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" name="inputpenulis" id="penulis" 
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" name="inputpenerbit" id="penerbit" 
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-10">
      <input type="date" class="form-control" name="inputtanggal" id="tanggal" 
